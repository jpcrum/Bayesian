...
setwd("C:/Users/sjcrum/Documents/Bayesian Statistics/Exercise3")
...
genMCMC = function( data , numSavedSteps=50000 , saveName=NULL ) { 
  ...
  #Combine three columns into one vector
  y = c(a, b, c)
  
  # s column is 1's for number of A, 2's for number of B, 3's for number of C
  s = c(rep(1, length(a)), rep(2, length(b)), rep(3, length(c)))
